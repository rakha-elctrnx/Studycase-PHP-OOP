...
$controller = new BukuController();
    ...
    if (isset($_GET['id'])) {
      ...
      $buku = $controller->getBukuId($id_buku);
    ...
    <form action="index.php" method="POST">
        ...
        <div class="mb-3">
            ...
            <select class="form-select" name="tema">
                ...
                <option value="Fiksi" <?= ($tema ?? '') == "Fiksi" ? "selected" : "" ?>>Fiksi</option>
                <option value="Sains" <?= ($tema ?? '') == "Sains" ? "selected" : "" ?>>Sains</option>
                <option value="Action" <?= ($tema ?? '') == "Action" ? "selected" : "" ?>>Action</option>
            </select>
        </div>
        <div class="mb-3">
